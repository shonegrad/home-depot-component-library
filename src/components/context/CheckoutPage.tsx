...
export function CheckoutPage() {
    return (
        <div className="bg-background min-h-screen font-sans transition-colors duration-300">
            {/* 1. Simplified Header */}
            <div className="bg-card border-b border-border sticky top-0 z-50 transition-colors duration-300">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <div className="flex items-center justify-between mb-8 px-4">
                            ...
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-xs font-medium font-bold text-foreground">Delivery</span>
                            </div>
                    ...
                    <div className="w-full lg:w-96 flex-shrink-0 space-y-6">
                        <div className="bg-card p-6 rounded-lg shadow-sm border border-border sticky top-24 transition-colors duration-300">
