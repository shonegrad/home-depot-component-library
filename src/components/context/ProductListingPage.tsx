...
export function ProductListingPage() {
    return (
        <div className="bg-background min-h-screen font-sans transition-colors duration-300">
            {/* 1. Global Header */}
            <div className="bg-card shadow-sm sticky top-0 z-50 transition-colors duration-300">
            ...
            <div className="container mx-auto px-4 py-4">
                ...
                <h1 className="text-3xl font-bold text-foreground mb-2">Power Tools</h1>
                <p className="text-muted-foreground mb-6">Shop the best selection of power tools from top brands like DeWalt, Milwaukee, and Ryobi.</p>
            ...
            <div className="container mx-auto px-4 pb-12 flex gap-8">
                ...
                <div className="w-64 flex-shrink-0 hidden lg:block space-y-6">
                    <div className="bg-card p-4 rounded-lg border border-border shadow-sm transition-colors duration-300">
